<%@ Page MasterPageFile="~/Admin/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="CategoryTreeView.aspx.cs" Inherits="HCSSS.CMS.CategoryTreeView" %>
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cplhContainer">
    ...
    <div class="pd05">
	    <telerik:RadTreeView ID="radTreeViewCategory" Runat="server" DataFieldID="Id" DataFieldParentID="PId" DataTextField="DisplayName" DataValueField="Id"
	     AllowNodeEditing="true" OnClientContextMenuItemClicking="onClientContextMenuItemClicking"
            OnClientContextMenuShowing="onClientContextMenuShowing" OnContextMenuItemClick="radTreeViewCategory_ContextMenuItemClick" OnNodeEdit="radTreeViewCategory_NodeEdit"
            EnableDragAndDrop="True" EnableDragAndDropBetweenNodes="true" OnNodeDrop="radTreeViewCategory_NodeDrop">
            <ContextMenus>
                <telerik:RadTreeViewContextMenu ID="MainContextMenu" runat="server">
                    <Items>
                        <telerik:RadMenuItem Value="AddNew" Text="Thêm danh mục con" ImageUrl="~/Images/SmallIcon/21.png">
                        </telerik:RadMenuItem>
                        <telerik:RadMenuItem Value="View" Text="Xem danh mục" ImageUrl="~/Images/SmallIcon/22.png">
                        </telerik:RadMenuItem>
                        <telerik:RadMenuItem Value="Edit" Text="Chỉnh sửa danh mục" ImageUrl="~/Images/SmallIcon/24.png">
                        </telerik:RadMenuItem>
                        ...
                        <telerik:RadMenuItem Value="Delete" Text="Xóa danh mục" ImageUrl="~/Images/7.gif">
                        </telerik:RadMenuItem>
                    </Items>
