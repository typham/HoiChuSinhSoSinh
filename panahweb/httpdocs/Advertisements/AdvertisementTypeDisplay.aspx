<%@ Page MasterPageFile="~/Admin/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="AdvertisementTypeDisplay.aspx.cs" Inherits="HCSSS.AddOn.Advertisement.AdvertisementTypeDisplay" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cplhContainer">
    <div class="pd05">
        ...
        <asp:Panel ID="pnlForm" runat="server" CssClass="form-editor-container">
            ...
            <br />
            <p>
                <asp:Label ID="lblNameLabel" runat="server" CssClass="label w150" Text="Loại quảng cáo:"></asp:Label>
