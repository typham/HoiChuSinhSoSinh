<%@ Page MasterPageFile="~/Admin/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="AdvertisementBlockDisplay.aspx.cs" Inherits="HCSSS.AddOn.Advertisement.AdvertisementBlockDisplay" %>
            ...
            <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0">
                <telerik:RadPageView ID="rpvCommonInfo" runat="server">
                    ...
                    <p>
                        ...
                        <asp:Label ID="lblTimeDelay" runat="server" CssClass="label w450" Text=""></asp:Label>
                        <br class="clear" />
                    </p>
                    <p>
                ...
                <telerik:RadPageView ID="rpvItem" runat="server">
                    <asp:Panel ID="pnlItem" runat="server">
                        <uc:PanelAdvItem ID="pnlAdvItem" runat="server" EditOption="0" />
                    </asp:Panel>
                </telerik:RadPageView>
