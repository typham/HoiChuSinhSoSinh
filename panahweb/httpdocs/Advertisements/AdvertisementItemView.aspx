<%@ Page MasterPageFile="~/Admin/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="AdvertisementItemView.aspx.cs" Inherits="HCSSS.AddOn.Advertisement.AdvertisementItemView" %>
            ...
            <telerik:RadGrid ID="radGridDefault" runat="server" AllowCustomPaging="True" AutoGenerateColumns="False"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Name" HeaderText="T&#234;n quảng c&#225;o" UniqueName="Name">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="TypeName" HeaderText="Loại quảng c&#225;o" UniqueName="TypeName">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridTemplateColumn HeaderText="Hình">
                        <ItemTemplate>
                            <img src="<%# Eval("FileLink1") %>" width="200px" height="100px" />
                        </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridHyperLinkColumn DataTextField="Link" DataNavigateUrlFields="Link" HeaderText="Link" UniqueName="Link" Target="_blank">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridHyperLinkColumn>
                        <telerik:GridBoundColumn DataField="StartTime" HeaderText="Ng&#224;y giờ bắt đầu" UniqueName="StartTime" DataFormatString="{0:dd/MM/yyyy HH:mm:ss tt}">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="EndTime" HeaderText="Ng&#224;y giờ kết th&#250;c" UniqueName="EndTime" DataFormatString="{0:dd/MM/yyyy HH:mm:ss tt}"   >
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
