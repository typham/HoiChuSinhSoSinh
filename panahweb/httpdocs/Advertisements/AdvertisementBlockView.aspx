<%@ Page MasterPageFile="~/Admin/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="AdvertisementBlockView.aspx.cs" Inherits="HCSSS.AddOn.Advertisement.AdvertisementBlockView" %>
            ...
            <telerik:RadGrid ID="radGridDefault" runat="server" AllowCustomPaging="True" AutoGenerateColumns="False"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Name" HeaderText="Tên block" UniqueName="Name">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ModeName" HeaderText="Chế độ" UniqueName="ModeName">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="TimeDelay" HeaderText="Thời gian hiển thị (ms)" UniqueName="TimeDelay" DataFormatString="{0:#,##0}">
                            <HeaderStyle Font-Bold="True" />
                            <ItemStyle HorizontalAlign="Right" />
                        </telerik:GridBoundColumn>
