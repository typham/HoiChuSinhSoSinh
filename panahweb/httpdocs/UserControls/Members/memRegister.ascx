<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="memRegister.ascx.cs" Inherits="HCSSS.Websites.UserControls.Members.memRegister1" %>
 ...
 <table class="Content">
        ...
        <tr>
            <td colspan="4" class="tblTitle">
                    <asp:Label ID="Label62" runat="server" Text="Thông tin cá nhân" 
                        CssClass="frm-label-title" Width="563px" Font-Bold="True" ForeColor="#FF3300"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="colTitle">                
                <asp:Label ID="lblFullName" class="frm-label" runat="server" Text="Họ và tên:" CssClass="frm-label" Width="100px"></asp:Label>
                </td>
            <td colspan="3" class="colContent">
                <asp:TextBox ID="txtFullName" runat="server" CssClass="frm-input" Width="200px"></asp:TextBox>
                <asp:Label ID="Label4" runat="server" CssClass="red" Text="*" 
        ...
        <tr>
            ...
            <td class="colContent">
                ...
                <asp:Label ID="Label3" runat="server" CssClass="red" Text="*" 
                    ForeColor="#FF3300"></asp:Label>                                                                              
            </td>
                <td>
                    &nbsp;</td>
        ...
        <tr>
            <td class="colTitle">
                <asp:Label ID="lblImages" runat="server" Text="Hình đại diện:" CssClass="frm-label" Width="100px"></asp:Label>
            </td>
            <td  class="colContent">
                <asp:FileUpload ID="fileUpImages" runat="server" />
            </td>
            <td  class="colContent">
        ...
        <tr>
            ...
            <td colspan="3" class="colContent">
                <asp:Button ID="btnUpImg" runat="server" onclick="btnUpImg_Click" Text="Up Server" />
            </td>
        </tr>
        <tr>
            <td colspan="4" class="tblTitle">
                <asp:Label ID="Label1" runat="server" Text="Chọn tên đăng nhập & mật khẩu" 
                    CssClass="frm-label-title" Width="300px" Font-Bold="True" ForeColor="#FF3300"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="colTitle">
                   <asp:Label ID="lblUserLogin" runat="server" Text="Tên đăng nhập:" CssClass="frm-label" Width="100px"></asp:Label>
            </td>
            <td  colspan="3" class="colContent">
                <asp:TextBox ID="txtUserLogin" runat="server" CssClass="frm-input" Width="200px"></asp:TextBox>
                <asp:Label ID="Label6" runat="server" CssClass="red" Text="*" 
                    ForeColor="#FF3300"></asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td  colspan="3" class="colContent">
                <asp:TextBox ID="txtPassword" runat="server" CssClass="frm-input" TextMode="Password" Width="200px"></asp:TextBox>
                <asp:Label ID="Label7" runat="server" CssClass="red" Text="*" 
                    ForeColor="#FF3300"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="colTitle">
                   <asp:Label ID="lblRepassword" runat="server" Text="Re - mật khẩu:" CssClass="frm-label" Width="100px"></asp:Label>
            </td>
            <td  colspan="3" class="colContent">
                <asp:TextBox ID="txtRepassword" runat="server" CssClass="frm-input" Width="200px"></asp:TextBox>
                <asp:Label ID="Label8" runat="server" CssClass="red" Text="*" 
                    ForeColor="#FF3300"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="4" class="tblTitle">
                <asp:Label ID="Label9" runat="server" Text="Thông tin liên hệ" 
                    CssClass="frm-label-title" Width="300px" Font-Bold="True" ForeColor="#FF3300"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="colTitle">
                <asp:Label ID="lblHomephone" runat="server" Text="Điện thoại nhà:" CssClass="frm-label" Width="100px"></asp:Label>
            </td>
            <td  colspan="3" class="colContent">
        ...
        <tr>
            <td colspan="4" class="tblTitle">
                <asp:Label ID="lblSecurity" runat="server" Text="Mã bảo vệ" 
                    CssClass="frm-label-title" Width="300px" Font-Bold="True" ForeColor="#FF3300"></asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td  colspan="3" class="colContent">
                <cc1:CaptchaControl ID="CaptchaControl1" runat="server" CaptchaBackgroundNoise="Medium" CaptchaLineNoise="Low" Width="100px" />
            </td>
        </tr>
        <tr>
            <td class="colTitle">
                <asp:Label ID="lblSecuritylbb" runat="server" Text="Nhập mã bảo vệ:" CssClass="frm-label" Width="100px"></asp:Label>
            </td>
            <td  colspan="3" class="colContent">
                <asp:TextBox ID="txtSecurity" runat="server" CssClass="frm-input" Width="200px"></asp:TextBox>
                <asp:Label ID="Label11" runat="server" CssClass="red" Text="*" 
                    ForeColor="#FF3300"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="4" class="tblTitle">
                <asp:Label ID="lblAgree" runat="server" Text="Điểu khoản thỏa thuận" 
                    CssClass="frm-label-title" Width="300px" Font-Bold="True" ForeColor="#FF3300"></asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td  colspan="3" class="colContent">
                ...
                <asp:LinkButton ID="lbtnAgree" runat="server">Điều khoản thỏa thuận</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td class="colTitle">
            ...
            <td  colspan="3" class="colContent">
               ...
               <asp:Button ID="btnChange" runat="server" Text="Thay đổi"  onclick="btnChange_Click" />
