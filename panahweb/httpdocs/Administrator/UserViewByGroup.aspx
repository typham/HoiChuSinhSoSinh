<%@ Page MasterPageFile="~/Admin/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="UserViewByGroup.aspx.cs" Inherits="HCSSS.Framework.Administrator.UserViewByGroup" %>
            ...
            <telerik:RadGrid ID="radGridDefault" runat="server" AllowCustomPaging="True" AutoGenerateColumns="False"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client" NoMasterRecordsText="Kh&#244;ng c&#243; bản ghi n&#224;o.">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="GroupName" HeaderText="Nhóm" UniqueName="GroupName">
