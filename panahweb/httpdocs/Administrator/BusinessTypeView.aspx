<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Default.Master" AutoEventWireup="true" CodeBehind="BusinessTypeView.aspx.cs" Inherits="HCSSS.Framework.Administrator.BusinessTypeView" %>
            ...
            <telerik:RadGrid ID="radGridDefault" runat="server" AutoGenerateColumns="False"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="BusinessTypeName" HeaderText="Loại doanh nghiệp" UniqueName="BusinessTypeName">
