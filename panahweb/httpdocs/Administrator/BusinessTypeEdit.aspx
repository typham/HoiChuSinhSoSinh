<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Default.Master" AutoEventWireup="true"
    CodeBehind="BusinessTypeEdit.aspx.cs" Inherits="HCSSS.Framework.Administrator.BusinessTypeEdit" %>
        ...
        <asp:Panel ID="pnlForm" runat="server" CssClass="form-editor-container">
            ...
            <p>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic"
                    ErrorMessage="Bạn phải nhập <b>Loại doanh nghiệp</b><br />" ControlToValidate="txtBusinessTypeName"
                    InitialValue="Nhập Loại doanh nghiệp" ValidationGroup="UserEdit"></asp:RequiredFieldValidator>
                <asp:Label ID="lblBusinessTypeNameLabel" runat="server" CssClass="label w150" Text="Loại doanh nghiệp:"></asp:Label>
                <telerik:RadTextBox ID="txtBusinessTypeName" runat="server" Width="450px" MaxLength="255">
                </telerik:RadTextBox>
                <br class="clear" />
            </p>
            <p>
