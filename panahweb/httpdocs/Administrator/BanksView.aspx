<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Default.Master" AutoEventWireup="true" CodeBehind="BanksView.aspx.cs" Inherits="HCSSS.Framework.Administrator.BanksView" %>
            ...
            <telerik:RadGrid ID="radGridDefault" runat="server" AutoGenerateColumns="False" GridLines="None"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="BankName" HeaderText="Tên ngân hàng"
                            UniqueName="BankName">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ShortName" HeaderText="Tên viết tắt" UniqueName="ShortName">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
