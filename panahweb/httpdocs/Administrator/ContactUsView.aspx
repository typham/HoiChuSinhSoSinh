<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Default.Master" AutoEventWireup="true" CodeBehind="ContactUsView.aspx.cs" Inherits="HCSSS.Framework.Administrator.ContactUsView" %>
            ...
            <telerik:RadGrid ID="radGridDefault" runat="server" AutoGenerateColumns="False" GridLines="None"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="YourCompany" HeaderText="Tên doanh nghiệp"
                            UniqueName="YourCompany">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Address" HeaderText="Tên tiếng anh" UniqueName="Address">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
