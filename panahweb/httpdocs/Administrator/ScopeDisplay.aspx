<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Default.Master" AutoEventWireup="true" CodeBehind="ScopeDisplay.aspx.cs" Inherits="HCSSS.Framework.Administrator.ScopeDisplay" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cplhContainer" runat="server">
    ...
    <div class="pd05">
        ...
        <asp:Panel ID="pnlForm" runat="server" CssClass="form-editor-container">
            ...
            <br />
            <p>
                <asp:Label ID="lblParentLabel" runat="server" CssClass="label w150" Text="Lĩnh vực :"></asp:Label>
