<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Default.Master" AutoEventWireup="true"
    CodeBehind="GalleryCategoryView.aspx.cs" Inherits="HCSSS.Framework.Administrator.GalleryCategoryView" %>
            ...
            <telerik:RadGrid ID="radGridDefault" runat="server" AllowCustomPaging="True" AutoGenerateColumns="False"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="albumname" HeaderText="T&#234;n Album" UniqueName="albumname">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="AlbumTypeName" HeaderText="Loại Album" UniqueName="AlbumTypeName">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
