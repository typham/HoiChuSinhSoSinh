<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Default.Master" AutoEventWireup="true"
    CodeBehind="WardsView.aspx.cs" Inherits="HCSSS.Framework.Administrator.WardsView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cplhContainer" runat="server">
    ...
    <div class="pd05">
        <telerik:RadAjaxPanel ID="radAjaxPanelView" runat="server" LoadingPanelID="radAjaxLoadingPanel1">
            <telerik:RadGrid ID="radGridDefault" runat="server" AutoGenerateColumns="False" GridLines="None"
                OnItemCommand="radGridDefault_ItemCommand" Style="outline: none" OnItemDataBound="radGridDefault_ItemDataBound"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="VietnameseName" HeaderText="Tên doanh nghiệp"
                            UniqueName="VietnameseName">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="EnglishName" HeaderText="Tên tiếng anh" UniqueName="EnglishName">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="BusinessTypeName" HeaderText="Loại doanh nghiệp"
                            UniqueName="BusinessTypeName">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridTemplateColumn HeaderText="Email">
                            ...
                            <ItemTemplate>
                                ...
                                </a><a href='mailto:<%#DataBinder.Eval(Container.DataItem, "Email")%>'>
                                    <img alt="gửi email" title="gửi email" width="16" src="/Images/SmallIcon/47.png" />
                                </a>
                            </ItemTemplate>
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Website">
                            <ItemStyle Wrap="False" />
                            <ItemTemplate>
                                <a target="_blank" href='<%#DataBinder.Eval(Container.DataItem, "Website")%>'>
                        ...
                        <telerik:GridBoundColumn DataField="Fax" HeaderText="Số Fax" UniqueName="Fax">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
