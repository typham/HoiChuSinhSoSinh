<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Default.Master" AutoEventWireup="true" CodeBehind="DistrictView.aspx.cs" Inherits="HCSSS.Framework.Administrator.DistrictView" %>
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                       <%-- <telerik:GridTemplateColumn HeaderText="#">
                        ...
                        <telerik:GridBoundColumn DataField="Name" HeaderText="T&#234;n TP, TX, Huyện" UniqueName="Name">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
