<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Default.Master" AutoEventWireup="true" CodeBehind="DistrictEdit.aspx.cs" Inherits="HCSSS.Framework.Administrator.DistrictEdit" %>
    ...
    <div class="pd05">
        <telerik:RadAjaxPanel ID="radAjaxPanelView" runat="server" LoadingPanelID="radAjaxLoadingPanel1">
            ...
            <asp:Panel ID="pnlForm" runat="server" CssClass="form-editor-container">
                ...
                <p>
                    <asp:Label ID="lblNameLabel" runat="server" CssClass="label w150" Text="Tên Huyện:"></asp:Label>
