<%@ Page MasterPageFile="~/Admin/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationView.aspx.cs" Inherits="HCSSS.Framework.Administrator.ConfigurationView" %>
            ...
            <telerik:RadGrid ID="radGridDefault" runat="server" AllowCustomPaging="True" AutoGenerateColumns="False"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Name" HeaderText="T&#234;n" UniqueName="Name">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Val" HeaderText="Giá trị" UniqueName="Val">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
