<%@ Page MasterPageFile="~/Admin/Popup.Master" Language="C#" AutoEventWireup="true" CodeBehind="PopupModulePolicy.aspx.cs" Inherits="HCSSS.Framework.Administrator.PopupModulePolicy" 
Title="Phân quyền" %>
        ...
        <telerik:RadAjaxPanel ID="radAjaxPanelView" runat="server" LoadingPanelID="radAjaxLoadingPanel">
            ...
            <asp:Panel ID="pnlRadGrid" runat="server" CssClass="radgrid">
                ...
                <p>
                    ...
                    <telerik:RadComboBox ID="radCmbModule" runat="server" Width="400px" AutoPostBack="True"
                        OnSelectedIndexChanged="radCmbModule_SelectedIndexChanged" DataTextField="Name" DataValueField="Id">
                        <CollapseAnimation Duration="200" Type="OutQuint" />
                    </telerik:RadComboBox>
                    <br class="clear" />
                </p>
