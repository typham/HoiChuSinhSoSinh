<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Default.Master" AutoEventWireup="true" CodeBehind="BusinessStatusView.aspx.cs" Inherits="HCSSS.Framework.Administrator.BusinessStatusView" %>
            ...
            <telerik:RadGrid ID="radGridDefault" runat="server" AutoGenerateColumns="False"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="BusinessStatusName" HeaderText="Trạng thái doanh nghiệp" UniqueName="BusinessStatusName">
