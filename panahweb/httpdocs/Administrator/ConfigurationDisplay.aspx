<%@ Page MasterPageFile="~/Admin/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationDisplay.aspx.cs" Inherits="HCSSS.Framework.Administrator.ConfigurationDisplay" %>
    ...
    <div class="pd05">
        ...
        <asp:Panel ID="pnlForm" runat="server" CssClass="form-editor-container">
            ...
            <p>
                ...
                <asp:Label ID="lblVal" runat="server" CssClass="label w450" Text=""></asp:Label>
                <br class="clear" />
            </p>
            <p>
