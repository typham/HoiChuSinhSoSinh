<%@ Page MasterPageFile="~/Admin/Default.Master" Language="C#" AutoEventWireup="true" CodeBehind="FunctionEdit.aspx.cs" Inherits="HCSSS.Framework.Administrator.FunctionEdit" %>
        ...
        <telerik:RadAjaxPanel ID="radAjaxPanelView" runat="server" LoadingPanelID="radAjaxLoadingPanel1">
            ...
            <asp:Panel ID="pnlForm" runat="server" CssClass="form-editor-container">
                ...
                <p>
                    ...
                    <telerik:RadComboBox ID="cmbModule" runat="server" DataTextField="Name" DataValueField="Id" Width="450px" AutoPostBack="True" OnSelectedIndexChanged="cmbModule_SelectedIndexChanged">
                    </telerik:RadComboBox>
                    <br class="clear" />
                </p>
                <p>
