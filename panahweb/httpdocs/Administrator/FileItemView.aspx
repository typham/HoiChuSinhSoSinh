<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Default.Master" AutoEventWireup="true" CodeBehind="FileItemView.aspx.cs" Inherits="HCSSS.Framework.Administrator.FileItemView" %>
            ...
            <telerik:RadGrid ID="radGridDefault" runat="server" AutoGenerateColumns="False"
                ...
                <MasterTableView ClientDataKeyNames="Id" DataKeyNames="Id" GroupLoadMode="Client"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="FolderName" HeaderText="Tên danh mục file" UniqueName="FolderName">
                         ...
                         <telerik:GridBoundColumn DataField="Keywords" HeaderText="Từ khóa" UniqueName="Keywords">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="FlieTypeName" HeaderText="Loại file" UniqueName="FlieTypeName">
                            <HeaderStyle Font-Bold="True" />
                        </telerik:GridBoundColumn>
