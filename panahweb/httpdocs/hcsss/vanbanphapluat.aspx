<%@ Page Title="" Language="C#" MasterPageFile="~/hcsss/hcsss.Master"
    AutoEventWireup="true" CodeBehind="vanbanphapluat.aspx.cs" Inherits="HCSSS.Framework.hcsss.vanbanphapluat" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <table width="100%" style="float: left; padding: 0px 10px 0px 10px; clear: both;
                        ...
                        <tr>
                            <td style="width: 20%;">
                                <asp:Label runat="server" ID="Label1" Text="Số hiệu văn bản :"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td style="width: 20%;">
                                <asp:Label runat="server" ID="Label2" Text="Trích yếu :"></asp:Label>
                            </td>
                            <td>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <asp:ListView ID="lstNews" runat="server" DataKeyNames="Id" EnableModelValidation="True"
                ...
                <ItemTemplate>
                    <li class="tungdong"><span class="masodndk1">
                        <asp:LinkButton ID="btnViewDetal" OnClick="btnViewDetal_Click" CssClass="dialog"
                            ToolTip="Xem chi tiết" runat="server" CommandName='<%#Eval("Id") %>'>  
                         <%#Eval("NumberDocument")%></asp:LinkButton>
                    </span><span class="tendn1">
                        <%#string.Format("{0:dd/MM/yyyy}",Eval("IssueDate"))%></span> <span class="diachidn1">
                            <asp:LinkButton ID="LinkButton1" OnClick="LinkButton1_Click" CssClass="dialog" ToolTip="Xem chi tiết"
                                runat="server" CommandName='<%#Eval("Id") %>'>
